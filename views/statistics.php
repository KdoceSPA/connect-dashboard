                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" style="color: #195ca6;">2025</th>
                                    ...
                                    <?php
                                        foreach ($schools['data']['data'] as $a => $school) {
                                            echo "<tr style=\"cursor: pointer;\">
                                                    ...
                                                    <td class=\"text-center\" style=\"color: " . $school['color_2025'] . ";\" onclick=\"showDetailsMonth('" . customUcwords($school['nombre']) . " - 2025', '" . $school['calendario_eventos_2025'] . "', '" . $school['calendario_timbres_2025'] . "', '" . $school['recursos_enviados_2025'] . "', '" . $school['mensajes_utp_2025'] . "', '" . $school['emergencias_medicas_2025'] . "', '" . $school['emergencias_conductuales_2025'] . "', '" . $school['mensajes_connect_2025'] . "')\"><b>" . $school['frecuencia_2025'] . "</b></td>
